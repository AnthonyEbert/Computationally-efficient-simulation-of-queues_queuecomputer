...
% This is a useful model for many real-world applications where the customer/server analogy applies such as: \citet{koole2002queueing} (call centers); \citet{lakshmi2013application} (hospitals); \cite{cao2003web} (web servers) and \citet{papadopoulos1996queueing} (manufacturing systems). For a detailed introduction to queueing theory see \citet{medhi2002stochastic,bhat2015introduction}. 
