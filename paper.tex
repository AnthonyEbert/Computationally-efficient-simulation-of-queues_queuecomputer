...
\Address{
  ...
  E-mail: \email{anthonyebert@gmail.com}\\
  URL: \url{https://anthonyebert.github.io/resume/}
}
...
The simulation was conducted on a system with Intel (R) Core(TM) i7-6700 CPU @ 3.40GHz running Debian GNU/Linux. The version of \proglang{R} is 4.0.2 ``Taking Off Again'' with \pkg{simmer} version 4.4.2 and \pkg{queuecomputer} version 0.9.1. The version of \proglang{Python} is 3.8.2 with \pkg{simpy} module version 4.0.1.
